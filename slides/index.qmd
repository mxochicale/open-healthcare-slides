...
<span style="color:#939393; font-size:1.5em; font-weight: bold;">Real-time AI for surgery with NVIDIA-Holoscan platform</span>  
...
[[[{{< fa brands github >}} `mxochicale/`](https://github.com/mxochicale/)]{style="border-bottom: 0.5px solid #00ccff;"}`{`[[`github-repo`](https://github.com/mxochicale/real-time-ai-for-surgery-with-NVIDIA-Holoscan-platform)]{style="border-bottom: 0.5px solid #00ccff;"}`}`]{style="font-size:0.8em;"}
:::
