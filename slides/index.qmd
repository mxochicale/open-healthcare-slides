...
::: footer
[20-Oct-2024 @ [grid-worms-animation 2023](https://github.com/saforem2/grid-worms-animation/)]{.dim-text style="text-align:left;'}
:::
...
::: {#fig-template}
![](figures/regulation-innovation/li2023-fig3.jpg){fig-align="center" width="100%"}
...
# Use cases: Fetal Ultrasound Image Synthesis {#sec-fus}
...
# Developing real-time AI applications for diagnosis {#sec-rtai}
...
# Use cases: Real-time AI diagnosis for endoscopic pituitary surgery {#sec-ps}
...
# Use cases: Real-time AI diagnosis for eye movement disorders {#sec-ed}

## :robot: :eyes: AI in ophthalmic imaging modalities

::: {#fig-template}
![](figures/ophthalmology/li2023-fig2.jpg){fig-align=center}
...
![](figures/nystagmus/animation-2024-09-13 16-45.gif){fig-align=center}
...
![](figures/ophthalmology/liu_2023_graphical_abstract.jpg){fig-align="center" width="50%"}

:::

::: {.column width="50%"}
* Implement UNET-Visual Transformer models (Yao et al. 2022)   
![](figures/ophthalmology/yao2022_fig1.png){fig-align="center" width="80%"}
...
The First Regulatory Clearance of an
Open-Source Automated Insulin
Delivery Algorithm
...
::: {style="font-size: 40%;"}
Braune, Katarina, Sufyan Hussain, and Rayhan Lal. "The first regulatory clearance of an open-source automated insulin delivery algorithm." Journal of Diabetes Science and Technology 17, no. 5 (2023): 1139-1141.
...
**YES!**
*We can Revolutionise Healthcare with Open-Source Software!!!*
